...
## 引言
本文件围绕 Doc2MD CLI 的模块化设计展开，系统阐述其模块边界、解耦策略、接口规范与扩展点。重点解析以下设计模式的应用与落地：
...
## 结论
Doc2MD CLI 的模块化设计以“工厂 + 策略 + 依赖注入”为核心，实现了清晰的模块边界、稳定的接口规范与良好的扩展性。通过 Listr 任务编排，模块间以上下文为纽带进行松耦合协作，既保证了可维护性，也为未来新增转换算法与处理流程提供了坚实基础。
