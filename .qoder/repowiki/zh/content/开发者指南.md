...
## 简介
本指南面向希望参与 doc2xml-cli 项目开发的工程师，覆盖开发环境搭建、代码贡献流程、调试技巧、代码规范、测试策略、性能优化、扩展与自定义、故障排除以及项目维护与长期发展策略。项目采用 TypeScript 编写，使用 esbuild 打包为可执行程序，内置 .NET 元文件转换器以处理 EMF/WMF 矢量图。
